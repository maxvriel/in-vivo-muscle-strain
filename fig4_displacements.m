...
for iRec = 1:length(recFiles)
    ...
    if iRec == 1
        hl = annotation(hFig, 'line', 'Color', 'w', ...
            ...
            'Y', size(images{iRec},2) - 10*[1,1]);
        hl.Parent = hAx;
        hl = annotation(hFig, 'line', 'Color', 'w', ...
            'X', size(images{iRec},1) - 10*[1,1], ...
            'Y', size(images{iRec},2) - 10 + [-5,5]);
        hl.Parent = hAx;
        text(size(images{iRec},1)-10+[0,0,-7.5,7.5], size(images{iRec},2)-10+[-7.5,7.5,0,0], ...
    ...
    if iRec == 1
        hl = annotation(hFig, 'line', 'Color', 'w', ...
            'X', size(images{iRec},1) - 10 + [-5,5], ...
            'Y', size(images{iRec},3) - 10*[1,1]);
        hl.Parent = hAx;
        hl = annotation(hFig, 'line', 'Color', 'w', ...
            'X', size(images{iRec},1) - 10*[1,1], ...
            'Y', size(images{iRec},3) - 10 + [-5,5]);
        hl.Parent = hAx;
        text(size(images{iRec},1)-10+[0,0,-7.5,7.5], size(images{iRec},3)-10+[-7.5,7.5,0,0], ...
    ...
    if iRec == 1
        ...
        hl.Parent = hAx;
        hl = annotation(hFig, 'line', 'Color', 'w', ...
            'X', size(images{iRec},2) - 10*[1,1], ...
            'Y', size(images{iRec},3) - 10 + [-5,5]);
        hl.Parent = hAx;
        text(size(images{iRec},2)-10+[0,0,-7.5,7.5], size(images{iRec},3)-10+[-7.5,7.5,0,0], ...
